...
$RunName = ("preexperiment_{0}_esm_concat_s42_{1}" -f $Mode.Replace("-", "_"), (Get-Date -Format "yyyyMMdd_HHmmss"))
$ConfigPath = Join-Path $ProjectRoot "config\experiments\preexperiment_esm_smoke.yaml"
